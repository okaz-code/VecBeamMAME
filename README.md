...
<sub>The logo is not artwork: it is a beam list, played back through this renderer.  A generator script writes it as an MVEC stream and `-vector_playback` draws it, one vector at a time, with the wordmark overdriven past full beam energy.</sub>
