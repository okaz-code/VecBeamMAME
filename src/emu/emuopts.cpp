...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_VECTOR_PLAYBACK_START ";vecstart",          "0",         core_options::option_type::INTEGER,    "seek to this frame when vector playback starts (0 = the beginning), so a run can be reproduced without driving the goto tool by hand" },
