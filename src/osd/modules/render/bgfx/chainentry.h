...
public:
	...
	// Override a named uniform's value at submit time (used to feed a per-frame CPU-computed value,
	// e.g. the accumulated monitor-glow amount, into a pass). Applied on top of the regular uniforms.
