...
const options_entry osd_options::s_option_entries[] =
{
	...
	{ OSDOPTION_BGFX_VEC_SUPERSAMPLE "(1-2)",    "2",               core_options::option_type::INTEGER,  "vector FBO supersampling factor (1 = window resolution, 2 = 2x); only used by chains declaring vector_engine=analytic" },
