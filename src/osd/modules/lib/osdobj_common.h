...
#define OSDOPTION_BGFX_OUTPUT_SCALE      "bgfx_output_scale"
...
#define OSDOPTION_BGFX_MACOS_EDR_ADAPTATION "bgfx_macos_edr_adaptation"
...
public:
	...
	float bgfx_output_scale() const { return float_value(OSDOPTION_BGFX_OUTPUT_SCALE); }
	...
	float bgfx_macos_edr_adaptation() const { return float_value(OSDOPTION_BGFX_MACOS_EDR_ADAPTATION); }
